...
const BUILT_IN_TOPICS = [
  {
    id: 'builtin-nominativ',
    name: 'Nominativ',
    nameZh: '第一格（主格）',
    description: '德語四格變化中的第一格，用作主語',
    builtin: true,
    questionCount: 0,
  },
  {
    id: 'builtin-akkusativ',
    name: 'Akkusativ',
    nameZh: '第四格（受格）',
    description: '德語四格變化中的第四格，用作直接賓語',
    builtin: true,
    questionCount: 0,
  },
  {
    ...
    name: 'Dativ',
    nameZh: '第三格（與格）',
    description: '德語四格變化中的第三格，用作間接賓語',
    builtin: true,
    questionCount: 0,
  },
  {
    ...
    name: 'Genitiv',
    nameZh: '第二格（屬格）',
    description: '德語四格變化中的第二格，表示所屬',
    builtin: true,
    questionCount: 0,
  },
  {
    id: 'builtin-konjugation',
    name: 'Verben Konjugation',
    nameZh: '動詞變位',
    description: '德語動詞在不同人稱和數中的變化',
    builtin: true,
    questionCount: 0,
  },
  {
